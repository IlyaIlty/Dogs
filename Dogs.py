...
def show_image():
    ...
    if image_url:
        try:
            ...
            #new_window.title("Слуцчайное изображение")
            ...
            mb.showerror("Ошибка", f'Возникла ошибка при загрузки излбражения {e}')
    progress.stop()
...
height_spinbox = ttk.Spinbox(from=200, to=500, increment=50, width=5)
height_spinbox.pack(side='left', padx=(0, 10))
height_spinbox.set(300)

top_level_wimdow = Toplevel(window)
top_level_wimdow.title('Изображения собачек')

notebook = ttk.Notebook(top_level_wimdow)
